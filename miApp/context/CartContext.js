...
import { API_URL } from '../config/config'; // ⬅️ Verifica esta ruta
...
const getCartTotal = () => {
  ...
  // Si cart es un objeto con items, calcular desde items
  if (cart && cart.items && Array.isArray(cart.items)) {
